...
params.P0_factor = 0;               % Excitation strength Determines Generation
...
params.Solution_Name = 'z_mutc4PN';
...
[Sol] = Obtain_Static_Solution(Design, params); 
if Sol.converged ==1
    [Sol_Dyn] = Obtain_Phase_Noise(Design, params,Sol);
end