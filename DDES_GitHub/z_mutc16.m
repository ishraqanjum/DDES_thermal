...
Design = {1, 'InGaAs',  50,  2.0e19,    0, 'Zn';  % 1
    1, 'InP',    100,  2.0e18,    0, 'Zn';  % 2
    1, 'InGaAsP', 15,  5.0e18,  1.1, 'Zn';  % 3
    1, 'InGaAsP', 15,  5.0e18,  1.4, 'Zn';  % 4
    1, 'InGaAs', 120,  5.0e18,    0, 'Zn';  % 5
    1, 'InGaAs', 180,  1.3e18,    0, 'Zn';  % 6
    1, 'InGaAs', 180,  4.0e17,    0, 'Zn';  % 7
    0, 'InGaAs', 160,  1.0e16,    0, 'Si';  % 8
    0, 'InGaAsP', 15,  1e16,  1.4, 'Si';  % 9
    0, 'InGaAsP', 15,  1e16,  1.1, 'Si';  % 10
    0, 'InP',     50,  1.9e17,    0, 'Si';  % 11
    0, 'InP',    300,  1.5e16,    0, 'Si';  % 12
    0, 'InP',    440,  1.2e16,    0, 'Si';  % 13
    -1, 'InP',    100,  1.0e18,    0, 'Si';  % 14
    -1, 'InP',    900,  1.0e19,    0, 'Si'}; % 15
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Device parameters
